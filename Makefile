...
SRCS = get_next_line/get_next_line.c get_next_line/get_next_line_utils.c src/1_init_structs/init.c src/1_init_structs/init2.c src/2_main/main.c src/utils/*.c src/map/finalize_map.c src/map/validate_map.c src/map/parse_map.c src/0_error/exit_erro.c src/free/*.c src/game/load_text.c src/rays/raycasting.c src/rendering/render.c src/map/mini_map.c src/move/player_move.c src/textures.c src/3_start_events/events.c
OBJS = $(SRCS:.c=.o)
